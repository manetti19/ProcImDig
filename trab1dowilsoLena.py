...
plt.imsave("lena_R.png", R, cmap="gray")
plt.imsave("lena_G.png", G, cmap="gray")
plt.imsave("lena_B.png", B, cmap="gray")
...
plt.imsave("lena_C.png", C, cmap="gray")
plt.imsave("lena_M.png", M, cmap="gray")
plt.imsave("lena_Y.png", Y, cmap="gray")

# =========================
# d.3) Recompor RGB
# =========================
rgb_recomposta = np.dstack([R, G, B])
plt.imsave("lena_rgb_recomposta.png", np.clip(rgb_recomposta, 0.0, 1.0))
...
plt.imsave("lena_H.png", (H / 360.0), cmap="gray")   # normaliza H para 0..1 só pra visualizar
plt.imsave("lena_S.png", np.clip(S, 0.0, 1.0), cmap="gray")
plt.imsave("lena_I.png", np.clip(I, 0.0, 1.0), cmap="gray")
...
plt.imsave("lena_ral.png", np.clip(lena_ral, 0.0, 1.0))

# 16) salva raster de índices em formato simples (NumPy) para checagem
np.save("lena_indice_ral.npy", idx_ral)

# 17) salva legenda (índice -> código RAL)
with open("lena_indice_ral_legenda.txt", "w", encoding="utf-8") as f:
